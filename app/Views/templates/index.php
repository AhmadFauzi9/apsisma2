...
<head>
    ...
    <link href="<?= base_url(); ?>/templates/node_modules/bootstrap4-toggle/css/bootstrap4-toggle.min.css" rel="stylesheet">

    <!-- Tambah Dewe -->
    <link href="<?= base_url(); ?>/templates/node_modules/datatables.net-bs4/css/dataTables.bootstrap4.css" rel="stylesheet">
    <!-- <link href="<?= base_url(); ?>/templates/node_modules/datatables.net-bs4/css/dataTables.bootstrap4.min.css" rel="stylesheet"> -->
    <!-- <link href="<?= base_url(); ?>/templates/node_modules/datatables/media/css/jquery.dataTables.min.css" rel="stylesheet"> -->
...
<body>
    <div id="app">
        <div class="main-wrapper">
            ...
            <div class="main-content">
                ...
                <?= $this->renderSection('absen-siswa'); ?>
                <?= $this->renderSection('rekapAbsen_Harian'); ?>
                <?= $this->renderSection('rekapAbsen_Bulanan'); ?>
                <?= $this->renderSection('input-absen'); ?>
                <?= $this->renderSection('profile-siswa'); ?>
                <?= $this->renderSection('profile-admin'); ?>
                <?= $this->renderSection('profile-guru'); ?>
                <?= $this->renderSection('detail-siswa'); ?>
                <?= $this->renderSection('detail-admin'); ?>
                <?= $this->renderSection('detail-guru'); ?>
                <?= $this->renderSection('userAdmin'); ?>
                <?= $this->renderSection('userGuru'); ?>
                <?= $this->renderSection('userSiswa'); ?>
                <?= $this->renderSection('semuaKelas'); ?>
                <?= $this->renderSection('kelasTujuh'); ?>
                <?= $this->renderSection('kelasDelapan'); ?>
                <?= $this->renderSection('kelasSembilan'); ?>
                <?= $this->renderSection('tambah-kelas'); ?>
                <?= $this->renderSection('pspdb'); ?>
                <?= $this->renderSection('spp'); ?>
                <?= $this->renderSection('kontak'); ?>
                <?= $this->renderSection('prestasi'); ?>
                <?= $this->renderSection('raport'); ?>
                <?= $this->renderSection('alumni'); ?>
                <?= $this->renderSection('riwayatKelas'); ?>
                <?= $this->renderSection('riwayatAsrama'); ?>
                <?= $this->renderSection('riwayatKesehatan'); ?>
                <?= $this->renderSection('profil'); ?>
                <?= $this->renderSection('visimisi'); ?>
                <?= $this->renderSection('prokel'); ?>
    ...
    <script src="<?= base_url(); ?>/templates/node_modules/datatables.net-bs4/js/dataTables.bootstrap4.js"></script>
