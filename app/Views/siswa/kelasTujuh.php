    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <ol class="breadcrumb bg-transparent px-0 my-0 py-0">
                ...
                <div class="breadcrumb-item"><a href="<?= base_url() ?>/siswa/userSiswa/">Daftar kelas 7</a></div>
            </ol>
        </div>
    </div>
</section>
...
<?php if ((session()->levelId == 1) || (session()->levelId == 2)) : ?>
    <section class="section">
        <div class="row mx-0 px-0">
            ...
            <div class="col px-0 mx-0">
                <form action="<?= base_url() ?>/siswa/KelasTujuh/" method="POST">
                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="row mx-1">
                        <div class="col mt-2">
                            ...
                            <form action="<?= base_url() ?>/siswa/pilih_bagianTujuh/<?= @$option_bagian ?>" method="post">
                                <!-- Select Kelas -->
                                            ...
                                            <select name="pilih_bagian" class="custom-select">
                                                ...
                                                foreach ($dataBagian as $bagian) :
                                                    foreach ($bagian as $bgn) {
                                                        ...
                                                        <option <?= $select ?> value="<?= $bgn ?>">Kelas 7-<?= $bgn ?></option>
                                                    <?php } ?>
                                                <?php endforeach; ?>
                                            </select>
                                            <div class="input-group-append">
