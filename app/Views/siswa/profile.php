    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <ol class="breadcrumb bg-transparent px-0 my-0 py-0">
                ...
                <div class="breadcrumb-item"><a href="<?= base_url() ?>/siswa/detail/<?= $dataStudent->username ?>">Detail Siswa</a></div>
            </ol>
        </div>
    </div>
</section>
            ...
            <div class="card card-statistic-1 pb-2">
                ...
                <div class="row card-body pl-0 mr-4 ml-2 mb-3">
                    ...
                    <div class="col-2 col-md-auto">
                        <div class="card-header text-right px-0 pt-3 mx-0">
                            <a href="#" class="btn btn-warning py-0" data-toggle="modal" data-target="#editProfile" style="box-shadow: none;">Edit</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col pb-3">
                    <div class="row px-0 mx-0" style="background-color: rgba(0, 0, 0, 0.02);">
                        <div class="col">
                            <div class="pb- pt-1 px-0 px-0"><strong>NIS / NISN</strong></div>
                        </div>

                        <div class="col-lg-9 col-md-auto">
                            <p class="align-middle pb-0">
                                <?php if ($dataStudent->username) : echo ($dataStudent->username . " / " . $dataStudent->nisn);
                                elseif ($dataStudent->nisn == "") : echo '<span class="text-danger font-weight-bold">&mdash;</span>';
                                endif ?>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row px-0 mx-0" style="background-color: #fff;">
                        ...
                        <div class="col-lg-9 col-md-auto">
                            <p class="align-middle pb-0">
                                <?= ($dataStudent->fullname) ? @ucwords($dataStudent->fullname) : '<span class="text-danger text-small">Kosong</span>'; ?>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row px-0 mx-0" style="background-color: rgba(0, 0, 0, 0.02);">
                        ...
                        <div class="col-lg-9 col-md-auto">
                            <p class="align-middle pb-0">
                                <?= ($dataStudent->gender) ? @ucwords($dataStudent->gender) :  '<span class="text-danger text-small">Kosong</span>'; ?>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row px-0 mx-0" style="background-color: #fff;">
                        <div class="col">
                            <div class="pb- pt-1 px-0"><strong>Kelas</strong></div>
                        </div>
                        <div class="col-lg-9 col-md-auto">
                            <p class="align-middle pb-0">
                                <?= ($dataStudent->kelas) ? @strtoupper($dataStudent->kelas) . " - " . @strtoupper($dataStudent->bagian) :  '<span class="text-danger text-small">Kosong</span>'; ?>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row px-0 mx-0" style="background-color: rgba(0, 0, 0, 0.02);">
                        <div class="col">
                            <div class="pb- pt-1 px-0"><strong>Asrama</strong></div>
                        </div>
                        <div class="col-lg-9 col-md-auto">
                            <p class="align-middle pb-0">
                                <?= ($dataStudent->asrama) ? @ucwords($dataStudent->asrama) . " - " . @strtoupper($dataStudent->kode) : '<span class="text-danger text-small">Kosong</span>'; ?>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row px-0 mx-0" style="background-color: #fff;">
                        ...
                        <div class="col-lg-9 col-md-auto">
                            <p class="align-middle pb-0">
                                <?php if ($dataStudent->tanggalLahir) :
                                    $namahari = @date('l', @strtotime($dataStudent->tanggalLahir));
                                    $split    = @explode('-', @$dataStudent->tanggalLahir);
                                    echo (@ucwords($dataStudent->tempatLahir) . ", " . @$split[2] . ' ' . @$bulan[(int)$split[1]] . ' ' . @$split[0] . ". " . "( Hari $hari[$namahari] )");
                    ...
                    <div class="row px-0 mx-0" style="background-color: rgba(0, 0, 0, 0.02);">
                        <div class="col">
                            <div class="pb- pt-1 px-0"><strong>Nama Ayah</strong></div>
                        </div>
                        <div class="col-lg-9 col-md-auto">
                            <p class="align-middle pb-0">
                                <?= ($dataStudent->namaAyah) ? @ucwords($dataStudent->namaAyah) : '<span class="text-danger text-small">Kosong</span>'; ?>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row px-0 mx-0" style="background-color: #fff;">
                        <div class="col">
                            <div class="pb- pt-1 px-0"><strong>Nama Ibu</strong></div>
                        </div>
                        <div class="col-lg-9 col-md-auto">
                            <p class="align-middle pb-0">
                                <?= ($dataStudent->namaIbu) ? @ucwords($dataStudent->namaIbu) : '<span class="text-danger text-small">Kosong</span>' ?>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row px-0 mx-0" style="background-color: rgba(0, 0, 0, 0.02);">
                        <div class="col">
                            <div class="pb- pt-1 px-0"><strong>Nomor Telp</strong></div>
                        </div>
                        <div class="col-lg-9 col-md-auto">
                            <p class="align-middle pb-0">
                                <?= ($dataStudent->nomorHp) ? ($dataStudent->nomorHp) : '<span class="text-danger text-small">Kosong</span>' ?>
                            </p>
                        </div>
                    </div>
